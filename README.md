...
&lt;p align="center"&gt; &lt;a href="<https://marketplace.visualstudio.com/items?itemName=feiskyer.chatgpt-copilot>" alt="Marketplace version"&gt; &lt;img src="<https://img.shields.io/visual-studio-marketplace/v/feiskyer.chatgpt-copilot?color=orange&label=VS%20Code>" /&gt; &lt;/a&gt; &lt;a href="<https://marketplace.visualstudio.com/items?itemName=feiskyer.chatgpt-copilot>" alt="Marketplace download count"&gt; &lt;img src="<https://img.shields.io/visual-studio-marketplace/d/feiskyer.chatgpt-copilot?color=blueviolet&label=Downloads>" /&gt; &lt;/a&gt; &lt;a href="<https://github.com/feiskyer/chatgpt-copilot>" alt="Github star count"&gt; &lt;img src="<https://img.shields.io/github/stars/feiskyer/chatgpt-copilot?color=blue&label=Github%20Stars>" /&gt; &lt;/a&gt; &lt;/p&gt;
...
- 💥 Model Context Protocol (MCP) to bring your own tools and DeepClaude (DeepSeek + Claude) mode for best AI responses.
...
- **v4.7.0**: Added Model Context Protocol (MCP) integration and Github Copilot AI provider.
...
&lt;details&gt; &lt;summary&gt; DeepSeek &lt;/summary&gt;
...
&lt;details&gt; &lt;summary&gt; Azure OpenAI &lt;/summary&gt;
...
&lt;details&gt; &lt;summary&gt; Github Models &lt;/summary&gt;
...
&lt;details&gt; &lt;summary&gt; OpenAI compatible Models &lt;/summary&gt;
...
&lt;details&gt; &lt;summary&gt; DeepClaude (DeepSeek + Claude) &lt;/summary&gt;
...
&lt;details&gt; &lt;summary&gt;AI Toolkit for TypeScript&lt;/summary&gt;
...
&lt;details&gt; &lt;summary&gt;gencay/vscode-chatgpt&lt;/summary&gt;
...
Unfortunately, the original author has decided to stop maintaining the project, and the new recommended Genie AI extension is not open-source. This fork continues the development to keep the project open and accessible to everyone. &lt;/details&gt;
